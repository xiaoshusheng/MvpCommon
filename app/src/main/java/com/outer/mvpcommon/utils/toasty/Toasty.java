package com.outer.mvpcommon.utils.toasty;
...
public class Toasty {
    ...
    private static final @ColorInt
    int ERROR_COLOR = Color.parseColor("#884e4d4d");
    private static final @ColorInt
    int INFO_COLOR = Color.parseColor("#884e4d4d");
    private static final @ColorInt
    int SUCCESS_COLOR = Color.parseColor("#884e4d4d");
    private static final @ColorInt
    int WARNING_COLOR = Color.parseColor("#884e4d4d");
